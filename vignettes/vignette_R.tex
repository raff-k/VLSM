...
\hypersetup{unicode=true,
            pdftitle={1 VLSM: Vector-based Landscape Metrics},
            colorlinks=true,
            linkcolor=Maroon,
            citecolor=Blue,
            urlcolor=blue,
...
\NormalTok{pacman}\OperatorTok{::}\KeywordTok{p_load}\NormalTok{(VLSM, dplyr, ggplot2, gridExtra, rgrass7, raster, link2GI, sf)}
...
{\centering \includegraphics{vignette_R_files/figure-latex/unnamed-chunk-3-1} 
