---
title: "VLSM: Vector-based Landscape Metrics in QGIS"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    keep_tex: true
...
In the following, a quick manual on how to use these functions in `QGIS`. If you want to use these functions via `R`, please refer to [here](https://github.com/raff-k/VLSM/blob/master/vignettes/vignette.pdf).
